...
public class BlockCard implements Initializable {
    @FXML
    ...
    @FXML
    private void BlockCardToMainMenu(ActionEvent e) throws IOException {
    ...
    @FXML
    private void deactivateMethod(ActionEvent e){
    ...
    private void sureCheckBoxMethod(ActionEvent e) throws SQLException, IOException {
        ...
        if(sureCheckBox.isSelected()){
            PreparedStatement preparedStatement1 = connection.prepareStatement("delete from customers where username = ?");
    ...
    @FXML
    private void BlockCardToLogIn(ActionEvent e) throws IOException {

...
public class CardFreeze implements Initializable {
    @FXML
    ...
    @FXML
    private void CardFreezeToMainMenu(ActionEvent e) throws IOException {
    ...
    @FXML
    private void freezeMethod(ActionEvent e){
            ...
            ResultSet resultSet = preparedStatement.executeQuery();
             ...
             if(resultSet.next()){
                ...
                if(status.equals("frozen")) {
                    errorLabel.setText("Your card is already locked!");
                    return;
                } else {
    ...
    @FXML
    private void CardFreezeToLogIn(ActionEvent e) throws IOException {

...
public class HistoryTransactionAdmins implements Initializable {
    @FXML
    ...
    @FXML
    private void HistoryTransactionsToHistory(ActionEvent e) throws IOException {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try {
            ...
            preparedStatement.setString(1, HistoryAdmins.customersUsername);

...
public class UnfreezeAdmins implements Initializable {
    @FXML
    ...
    @FXML
    private void CardUnfreezeToMainMenuAdmins(ActionEvent e) throws IOException {
    ...
    @FXML
    private void unfreezeAdminsMethod(ActionEvent e){
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                if (status.equals("active")) {
                    errorLabel.setText("Card is already active!");
                    resultSet.close();
                    ...
                    if (rows > 0) {
                        LogIn.currentUser = username;
                        errorLabel.setText("Card has been successfully reactivated!");
                    } else {

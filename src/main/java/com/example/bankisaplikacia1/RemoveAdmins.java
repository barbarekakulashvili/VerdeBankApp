...
public class RemoveAdmins implements Initializable {
    @FXML
    ...
    @FXML
    private void RemoveCustomerToMainMenuAdmins(ActionEvent e) throws IOException {
    ...
    @FXML
    private void removeAdminsMethod(ActionEvent e){
        ...
        try {
            ...
            if(!resultSet.next()){
                ...
                PreparedStatement preparedStatement2 = connection.prepareStatement("delete from customers where username = ?");
                preparedStatement2.setString(1, username);
                int rows = preparedStatement2.executeUpdate();
                if(rows > 0){
                    errorLabel.setText("Customer successfully removed!");
                }
                preparedStatement1.close();
            }else errorLabel.setText("No");
